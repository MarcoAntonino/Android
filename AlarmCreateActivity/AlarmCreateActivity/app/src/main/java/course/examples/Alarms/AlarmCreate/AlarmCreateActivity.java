...
public class AlarmCreateActivity extends Activity {
	...
	protected static final long JITTER = 5000L; //si usa per aggiungere un tempo casuale a un'operazione
	/*
	Per esempio quando sto mandando un segnale alla rete ed è occupata, ma lo faccio
	in contemporanea con un altro, devo avere un tempo casuale dopo cui riprovare o
	lo faremo sempre insieme
	 */
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		singleAlarmButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				mAlarmManager.set(AlarmManager.RTC_WAKEUP, //è una costante che consente di decidere se nel caso in cui il telefono sia sleeping, debba essere svegliato
		...
		repeatingAlarmButton.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				mAlarmManager.setRepeating(AlarmManager.ELAPSED_REALTIME, //set repeating: oltre ad essere eseguito in un certo momento, si aspettano 15 min e si rifaranno
