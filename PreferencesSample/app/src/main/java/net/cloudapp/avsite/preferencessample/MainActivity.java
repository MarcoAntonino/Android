...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); //serve a visualizzare la UI

        final SharedPreferences prefs = getPreferences(MODE_PRIVATE); //rappresenta le nostre shared preferences

        // High Score
        final TextView highScore = (TextView) findViewById(R.id.high_score_text); // presi i vari riferimenti alle varie variabili
        ...
        // Play Button
        final Button playButton = (Button) findViewById(R.id.play_button);//sono final ma per vezzo, non indispensabile
        playButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Random r = new Random(); //istanzia un oggetto di tipo random
